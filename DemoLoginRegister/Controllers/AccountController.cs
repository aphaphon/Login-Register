...
using DemoLoginRegister.Models;
using Microsoft.AspNetCore.Mvc;

namespace DemoLoginRegister.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        // POST api/account
        [HttpPost]
        public RegisterResult Post([FromBody] Account account)
        {
        ...
        [HttpPost("Login")]
        public LoginResult Login([FromBody] Account login)
        {
            //ดึงข้อมูล
